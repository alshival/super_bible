...
See [Large Language Models: An Application in Data Processing](https://github.com/alshival/upgraded-journey/blob/main/openAI_and_data_processing.ipynb) for an example of translating verses using openAi's davinci model. 
